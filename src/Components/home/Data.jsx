...
const Data = () => {
  return (
    <div className='home__data'>
      <h1 className='home__title'>Manoj Saligrama Harisha
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
      ...
      <h3 className="home__subtitle">
        Full Stack Web Developer & Data Science Aspirant
      </h3>
      <p className="home__description">
        I'm creative designer, building bridges Between Web Development and Data Science by Uniting Technology's Frontiers.
      </p>
